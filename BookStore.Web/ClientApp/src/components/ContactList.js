...
class ContactList extends Component {
    ...
    save() {
        ...
        this.dialogHide();
        this.growl.show({ severity: 'success', detail: this.newContact ? "Data Saved Successfully" : "Data Updated Successfully" });
    }
    ...
    render() {
        ...
        let header = <div className="p-clearfix" style={{ lineHeight: '1.87em' }}>Popular Books</div>;
        ...
        let dialogFooter = <div className="ui-dialog-buttonpane p-clearfix">
            ...
            <Button label="Delete" disabled={this.newContact ? true : false}  icon="pi pi-times" onClick={this.delete} />
            <Button label={this.newContact ? "Save" : "Update"} icon="pi pi-check" onClick={this.save} />
        </div>;
        ...
        return (
            <div>
                ...
                <DataTable value={this.props.contacts} selectionMode="single" header={header} footer={footer} selection={this.state.selectedContact} onSelectionChange={e => this.setState({ selectedContact: e.value })} onRowSelect={this.onContactSelect}>
                    ...
                    <Column field="lastName" header="Category" />
                    <Column field="email" header="Author" />
                    <Column field="phone" header="Price" />
                </DataTable>
                <Dialog visible={this.state.displayDialog} style={{ 'width': '380px' }} header="Contact Details" modal={true} footer={dialogFooter} onHide={() => this.setState({ displayDialog: false })}>
                    {
                        ...
                        <div className="p-grid p-fluid">
                            ...
                            <div style={{ paddingTop: '10px' }}><label htmlFor="lastName">Last Name</label></div>
                            <div>
                            ...
                            <div style={{ paddingTop: '10px' }}><label htmlFor="lastName">Phone</label></div>
                            <div>
